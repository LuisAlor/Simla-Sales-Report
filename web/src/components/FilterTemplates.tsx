        ...
        saving ? (
          <div className="flex gap-1 mt-1">
            <input
              ...
              placeholder="Nombre (admite emojis 🎯)…"
              className="flex-1 min-w-0 bg-navy-border text-white text-xs rounded-md px-2 py-1 border border-teal focus:outline-none placeholder-slate-600"
            />
