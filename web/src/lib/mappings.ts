...
export const FUNNEL_KEY_STAGES: StageEntry[] = [
  ...
  ["🔁 Seguimiento largo plazo",  "seguimiento-largo-plazo-dolgosrochnoe-soprovozhdenie"],
...
export const FUNNEL_NEGATIVE_STAGES: StageEntry[] = [
  ...
  ["🔩 No se adaptó al CRM",          "no-se-adapto-a-funcionalidad-del-crm-net-fichei"],
  ...
  ["😪 No le intereso el producto",   "no-le-intereso-el-producto-ne-interesen-produkt"],
  ...
  ["🙅 No es nuestro cliente",        "no-es-nuestro-cliente-nekachestvennyi-lid"],
];
